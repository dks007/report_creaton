...
class SuccessCreateReportSerializer(serializers.Serializer):
    ...
    parent_key = serializers.CharField(max_length=20,required=False)
    menu_card = serializers.CharField(max_length=20)
    capability = serializers.CharField(max_length=100)
    sub_capability = serializers.CharField(max_length=255,required=False)
    product = serializers.CharField(max_length=100)
    expert_name = serializers.CharField(max_length=100)
    customer_name = serializers.CharField(max_length=100)
    project_name = serializers.CharField(max_length=100,required=False)
    snow_case_no = serializers.CharField(max_length=100)
    sdm_name = serializers.CharField(max_length=100,required=False)
    csm_name = serializers.CharField(max_length=100,required=False)
    sdo_name = serializers.CharField(max_length=100,required=False)
    creator_email = serializers.CharField(max_length=100,required=False)
    creator_name = serializers.CharField(max_length=100,required=False)
