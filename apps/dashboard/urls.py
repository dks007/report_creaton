...
from .views import access_data, access_specific_data, MenuViewSet, ProjectViewSet, SubCapabilityViewSet, \
...
urlpatterns = [
    ...
    path('issue-listing/', access_data),
    path('issue-details/<str:id>', access_specific_data),
