    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(blank=True, default=datetime.date(2024, 1, 15))),
                ('updated_date', models.DateTimeField(blank=True, default=datetime.date(2024, 1, 15))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capability_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.capabilitymaster')),
                ...
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.productmaster')),
                ...
                ('sub_capability_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.subcapabilitymaster')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=datetime.date(2024, 1, 15))),
                ('updated_date', models.DateTimeField(default=datetime.date(2024, 1, 15))),
                ('status', models.CharField(blank=True, max_length=255, null=True)),
