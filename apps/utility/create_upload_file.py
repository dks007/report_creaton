...
def executeSchedulerJob(issueKey):
    ...
    doc = DocxTemplate(
        "C:\\Users\\lokain\\Documents\\workarea\\Success-Pilot-Web-Project\\IFS_Success_Final_Report_Template.docx")
    ...
    context = {
        ...
        'Insert_Customer_branding_here': InlineImage(doc,
                                                     'C:\\Users\\lokain\\Documents\\workarea\\Success-Pilot-Web-Project\\acmeCorporation.png'),
